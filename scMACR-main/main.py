...
def train(train_loader,
          ...
          lambda_byol=1.0):
    """
    Core training procedure for the scMACR model.
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="scMACR: Graph Contrastive Learning for Single-Cell Analysis")
